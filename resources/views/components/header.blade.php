<header>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#pmit-navbar" aria-controls="pmit-navbar" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="pmit-navbar">
            <div class="navbar-nav">
                <a href="{{ route('top') }}" class="nav-item nav-link">トップページ</a>
